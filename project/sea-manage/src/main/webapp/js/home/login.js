...
Login.initPage = function(){
	...
	$("#login_btn").bind("click", function(){
		...
		//window.location.href= Login.contextPath+"/users/queryUser.do";
		window.location.href= Login.contextPath+"/role/queryRoleList.do";
		//window.location.href= Login.contextPath+"/menu/queryMenuList.do";
	});
