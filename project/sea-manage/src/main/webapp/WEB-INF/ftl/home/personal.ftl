...
<body >
	...
	<!-- 个人中心 -->
				...
				<p class="todo">温馨提示</p>
				<div>
					<img src="../images/tip-5.png" alt="" />提示：资料完善100%可以得到更多权限
					<button class="activation">邮箱激活</button> or <button class="verification">手机验证</button>
				</div>
				<div>
					<img src="../images/tip-6.png" alt="" />提示：您参加的<span class="remnum"> 3 </span>个投标，已经进入倒计时状态，请及时关注！
				</div>
				<div>
					<img src="../images/tip-7.png" alt="" />提示：您今天有<span class="remnum1"> 3 </span>个日程安排，这周有<span class="remnum1"> 5 </span>个日程安排，这个月有<span class="remnum1"> 8 </span>个日程安排
				</div>
			</div>
