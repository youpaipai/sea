...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${base}/css/menu/menu.css"/>
    <link  rel="stylesheet" type="text/css"  href="${base }/css/zTreeStyle/zTreeStyle.css"/>
	<script type="text/javascript" src="${base }/js/menu/menu_button.js"></script>
...
<body >
	<div class="pmainbox">
		...
		<div class="rightnav">
			<div class="pnav">
				<span class="position">当前位置：<a href="javascript:void(0);">菜单管理</a> > 菜单 [ 新增 ] </span>
				<ul class="righttip">
			   ...
			   <p class="todo">基本信息</p>
			      <div class="topdda">
				      ...
				      <#if op=='add'>		
					   <input type="hidden" id="op" value="add"/>
						<tr>
							...
							<td><input type="text" name="menuname" id="menuname" value="" class="margin_tr" /></td>			
						
						</tr>
						<tr>
							<td><span >菜单路径：</span></td>
							<td>
							    <input type="text"  name="urlpath" id="urlpath"  class="margin_tr" />						  
							</td>
						</tr>
						<tr>
							<td><span>父级菜单：</span></td>
							<td>
								<select id="parentid" name="parentid" style="width:145px;margin-top:10px;" >
					...
					<#if op=='edit'>	
						...
						<input type="hidden" id="menuid" value="${m.menuId }"/>
							<tr>
							<td><span>菜单名称：<span></span></td>
							<td><input type="text" name="menuname" id="menuname" value="${m.menuName }"  class="margin_tr"/></td>						
						</tr>
						<tr>
							<td><span >菜单路径：</span></td>
							<td>
							    <input type="text"  name="urlpath" id="urlpath"  value="${m.urlpath }" class="margin_tr" />						  
							</td>
							<td><span>父级菜单：</span></td>
							<td>
								<select id="parentid" name="parentid"   style="width:145px;margin-top:10px;" >
