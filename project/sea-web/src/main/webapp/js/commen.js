		$(function(){
			...
			$('.set1').click(function(){
				...
				$(this).find('span').css('color','rgb(149, 161, 168)');
				$('.set2').find('img:first').attr('src','../images/6.png');
				$('.set3').find('img:first').attr('src','../images/14.png');
			})
			...
			$('.leftnav ul a').mouseenter(function(){
				$(this).css('background-color','#FF8B00');
			})
			
			$('.leftnav ul a').mouseleave(function(){
				$(this).css('background-color','#F4F4F4');
			})
			
			$('.leftnav ul li ul li').mouseenter(function(){
				$(this).css('background-color','#FF8B00');
			})
			
			$('.leftnav ul li ul li').mouseleave(function(){
				$(this).css('background-color','#F4F4F4');
			})
			...
			$('.leftnav ul a').click(function(){
				$('.set1-1b').find('li').find('img').attr('src','../images/13.png');
				$('.set1-2b').find('li').find('img').attr('src','../images/3.png');	
				$('.set1-3b').find('li').find('img').attr('src','../images/4.png');	
				$('.set1-4b').find('li').find('img').attr('src','../images/m-disable.png');
				$('.set1-5b').find('li').find('img').attr('src','../images/alarm.png');
				$('.set3-1b').find('li').find('img').attr('src','../images/15.png');
				$('.set3-2b').find('li').find('img').attr('src','../images/16.png');
				$('.set3-3b').find('li').find('img').attr('src','../images/9.png');
				$('.set3-4b').find('li').find('img').attr('src','../images/17.png');
			})
			
			$('.set1-1b').click(function(){
				$(this).find('li').find('img').attr('src','../images/13-1.png');
			})
			$('.set1-2b').click(function(){
				$(this).find('li').find('img').attr('src','../images/3-1.png');
			})
			$('.set1-3b').click(function(){
				$(this).find('li').find('img').attr('src','../images/4-1.png');
			})
			$('.set1-4b').click(function(){
				$(this).find('li').find('img').attr('src','../images/m-disable1.png');
			})
			$('.set1-5b').click(function(){
				$(this).find('li').find('img').attr('src','../images/alarm-1.png');
			})
			$('.set3-1b').click(function(){
				$(this).find('li').find('img').attr('src','../images/15-1.png');
			})
			$('.set3-2b').click(function(){
				$(this).find('li').find('img').attr('src','../images/16-1.png');
			})
			$('.set3-3b').click(function(){
				$(this).find('li').find('img').attr('src','../images/9-1.png');
			})
			$('.set3-4b').click(function(){
				$(this).find('li').find('img').attr('src','../images/17-1.png');
			})
			...
			$('.shousuo').click(function(){
				if($('.leftnav').is(':visible')){
					...
					$('.leftbussmain').css('width','48%');
					$('.leftbussmain .reminder ').css('width','auto');
					$('.leftbussmain .reminder ').css('margin','0px');
					$('.rightbussmain .reminder ').css('width','auto');
					$('.rightbussmain .reminder ').css('margin','0px');
				}
            ...
            /*导航栏下拉菜单*/
            $('.biddernav li:not(.nav-arrow)').mouseenter(function(){
            	$(this).find('ul').show();
            })
            $('.biddernav li:not(.nav-arrow)').mouseleave(function(){
            	$(this).find('ul').hide();
            })
			...
			/*导航条li自适应宽度*/
			var bidnav=$('.biddernav').width();
			var bidnavli=bidnav/11-6;
			$('.biddernav li').css('width',bidnavli);
