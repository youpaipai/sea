...
<body >
	<div class="bidder-navbox">
		...
		<div class="paylocation">
			<p>当前位置：保证金 > <a href="javascript:void(0);">上传投标文件</a></p>
		</div>
		<div class="paymentbox">
			...
			<div class="leftpay">
				<ul>
					...
					<li class="activevv"><span></span>上传投标文件</li>
				...
				<div class="bfbd">
					...
					<span class="filetext">开标项目一览表：</span>
					<div id="fileDivFILE_ID" <#if fileId??>style="display: none;"</#if>>
						<input type="hidden" name="TTFILEID" id="UPLOAD_FILE_ID" value="" />
						<#assign wjlx="FILE_ID" />
						<#assign fileSize="10000MB" />
						<#assign formart="*.docx;*.doc;*.zip" />
						<#assign isMulti="false" />
						<#assign disabled="false" />
						<#assign delFile="delFileByPathName" />
					...
					<button type="button" style="margin-top:50px;">提交</button>
				</div>
			</div>
		</div>
	</div>
