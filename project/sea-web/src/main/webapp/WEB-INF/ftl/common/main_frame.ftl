...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${base}/css/master.css?v=${ req.version!'' }"/>
	<link rel="stylesheet" href="${base}/css/kkpager_blue.css?v=${ req.version!'' }"/>
	
	<@styleHtml />
	
	<!-- JQuery -->
	<script type="text/javascript" src="${base}/js/plugin/jquery/jquery.min.js?v=${ req.version!'' }"></script>
	<script src="${base}/js/jquery.placeholder.min.js?v=${ req.version!'' }" type="text/javascript" charset="utf-8"></script>
	<script src="${base}/js/kkpager.min.js?v=${ req.version!'' }"></script>
	<script src="${base}/js/subbase.js?v=${ req.version!'' }"></script>
	<script src="${base }/js/commen.js?v=${ req.version!'' }" type="text/javascript" charset="utf-8"></script>
	...
	<script type="text/javascript" src="${base}/js/common/mainFrame.js?v=${ req.version!'' }"></script>
	<script type="text/javascript">
		MainFrame.initPage();
	</script>
